...
public class Easy {
    ...
    public void easy(Button polje[][], Player trenutniIgrac, Player sljedeciIgrac)
    {
        AI ai= new AI();

        if(ai.stranaProvjera(polje, trenutniIgrac, sljedeciIgrac)!=0) {
        ...
        else if(ai.winProvjera(polje, trenutniIgrac, sljedeciIgrac)!=0) {
